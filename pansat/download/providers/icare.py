...
ICARE_PRODUCTS = {
    ...
    "satellite.cloudsat.l2c_precip_column": ["SPACEBORNE", "CLOUDSAT", "2C-PRECIP-COLUMN"],
    "satellite.cloudsat.l2c_rain_profile": ["SPACEBORNE", "CLOUDSAT", "2C-RAIN-PROFILE"],
    "satellite.cloudsat.l2c_snow_profile": ["SPACEBORNE", "CLOUDSAT", "2C-SNOW-PROFILE.v05.06"],
