...
class IMERGProduct(GPMProduct):
    ...
    def get_granules(self, file_record: FileRecord) -> List[Granule]:
        return [Granule(
            file_record,
            self.get_temporal_coverage(file_record),
...
l2a_clim_gprof_metopb_mhs_v07a = GPROFProduct("GPROF2021v1", "METOPB", "MHS", "07A", variant="CLIM")
l2a_clim_gprof_metopb_mhs_v08a = GPROFProduct("GPROFNNv1", "METOPB", "MHS", "08A", variant="CLIM")
l2a_gprof_metopc_mhs_v07a = GPROFProduct("GPROF2021v1", "METOPC", "MHS", "07A", variant="CLIM")
l2a_clim_gprof_metopc_mhs_v08a = GPROFProduct("GPROFNNv1", "METOPC", "MHS",  "08A", variant="CLIM")
l2a_gprof_noaa20_atms = GPROFProduct("GPROF2021v1", "NOAA20", "ATMS", "07A")
l2a_clim_gprof_noaa19_mhs = GPROFProduct("GPROF2021v1", "NOAA19", "MHS", "07A", variant="CLIM")
...
l2a_clim_gprof_f16_ssmis_v07a = GPROFProduct("GPROF2021v1", "F16", "SSMIS", "07A", variant="CLIM")
l2a_clim_gprof_f17_ssmis_v07a = GPROFProduct("GPROF2021v1", "F17", "SSMIS", "07A", variant="CLIM")
l2a_clim_gprof_f17_ssmis_v08a = GPROFProduct("GPROFNNv1", "F17", "SSMIS", "08A", variant="CLIM")
l2a_clim_gprof_f18_ssmis_v07a = GPROFProduct("GPROF2021v1", "F18", "SSMIS", "07A", variant="CLIM")
l2a_clim_gprof_f18_ssmis_v08a = GPROFProduct("GPROFNNv1", "F18", "SSMIS", "08A", variant="CLIM")
l2a_gprof_npp_atms = GPROFProduct("GPROF2021v1", "NPP", "ATMS", "07A")
l2a_clim_gprof_npp_atms_v07a = GPROFProduct("GPROF2021v1", "NPP", "ATMS", "07A", variant="CLIM")
l2a_clim_gprof_npp_atms_v08a = GPROFProduct("GPROFNNv1", "NPP", "ATMS", "08A", variant="CLIM")
...
l2a_gprof_gcomw1_amsr2_v08a = GPROFProduct("GPROFNNv1", "GCOMW1", "AMSR2", "08A")
...
l2a_clim_gprof_trmm_tmi = GPROFProduct("GPROF2021v1", "TRMM", "TMI", "07A", variant="CLIM")
l2a_clim_gprof_noaa15_amsub = GPROFProduct("GPROF2021v1", "NOAA15", "AMSUB", "07A", variant="CLIM")
l2a_clim_gprof_f13_ssmi = GPROFProduct("GPROF2021v1", "F13", "SSMI", "07A", variant="CLIM")
l2a_clim_gprof_f15_ssmi = GPROFProduct("GPROF2021v1", "F15", "SSMI", "07A", variant="CLIM")


class GPROFV08Product(GPMProduct):
    """
    Specialization of GPM product for GPROF products, which all have the same
    data format.
    """
    ...
    def __init__(self, gprof_algorithm, platform, sensor, version, variant=""):
        module_path = Path(__file__).parent
        description = ProductDescription(module_path / "gprof_v08.ini")
        super().__init__(
            "2A", platform, sensor, gprof_algorithm, version, variant, description
        )
